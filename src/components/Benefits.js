...
const Benefits = () => {
    return (
        <div name='benefits' className='bg-orange-50'>
            <div className='font-inter flex justify-center md:justify-start px-[125px] py-14'>
                <h2 className='text-[15px]  md:text-4xl font-bold text-gray-800 underline-offset-4 underline'>Patient Care & Services</h2>
                
            </div>
            <div className='flex flex-col  md:grid md:grid-cols-3 px-[150px] font-inter gap-11'>
                    <div className='flex flex-col md:flex-row items-center gap-12'>
                        <LuBed size={60} className='text-red-600  '/>
                        <div className='flex flex-col md:text-start w-[300px]'>
